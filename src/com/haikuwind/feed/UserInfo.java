...
public class UserInfo {
	public enum Rank {
		APPRENTICE(1, R.string.apprentice),
		JOURNEYMAN(2, R.string.journeyman),
		MASTER(3, R.string.master),
		PRIEST(4, R.string.priest),
		DEVIL(5, R.string.devil),
		DAEMON(6, R.string.daemon),
		GOD(7, R.string.god);
