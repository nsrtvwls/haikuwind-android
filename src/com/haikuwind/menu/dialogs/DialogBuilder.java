...
public class DialogBuilder {
	    ...
	    builder.setPositiveButton(R.string.send, new DialogInterface.OnClickListener() {
	           public void onClick(DialogInterface dialog, int id) {
	        	   if(DialogInterface.BUTTON_POSITIVE==id) {
	            	   ...
	            	   HttpRequest.newHaiku(UserInfoHolder.getUserId(), haiku);
	        	   }
	           }
	       });
	...
	private View buildUserInfoDialog(LayoutInflater inflater, Builder builder) {
	    ...
	    ((TextView) layout.findViewById(R.id.user_rank)).setText(user.getRank().getRankStringId());
	    ...
	    value = Integer.toString(user.getFavoritedTimes()) + " " + context.getString(R.string.times);
	    ((TextView) layout.findViewById(R.id.user_favorited_times)).setText(value);
